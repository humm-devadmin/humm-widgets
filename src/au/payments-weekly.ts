...
function generateWidget(productPrice: number, noLogo: boolean, min: number, max: number, used_in: string): string {
    ...
    if (productPrice < min){
        template = `<a id="humm-tag-02" data-remodal-target="${Config.priceInfoModalId}">
                            <p>or 8 weekly payments </b></p><p>Interest free with <span id="humm-img"></span></p>
                        </a>`;

        templateCheckout = `<a id="humm-tag-02" data-remodal-target="${Config.priceInfoModalId}">
                            <p>8 weekly payments </b></p><p>Interest free with <span id="humm-img"></span></p>
                        </a>`;
        ...
        if (productPrice > 1400) {
            ...
            template = `<a id="humm-tag-02" data-remodal-target="${Config.priceInfoModalId}">
                            ...
                            <p>Interest free with <span id="humm-img"></span><span class="more-info">more info</span></p>
                        </a>`;
            ...
            template = `<a id="humm-tag-02" data-remodal-target="${Config.priceInfoModalId}">
                            <p>or 8 weekly payments of <b>$${roundedDownProductPrice.toFixed(2)}</b></p><p>Interest free with <span id="humm-img"></span><span class="more-info">more info</span></p>
                        </a>`;

            templateCheckout = `<a id="humm-tag-02" data-remodal-target="${Config.priceInfoModalId}">
                            <p>8 weekly payments of <b>$${roundedDownProductPrice.toFixed(2)}</b></p><p>Interest free with <span id="humm-img"></span><span class="more-info">more info</span></p>
                        </a>`;
